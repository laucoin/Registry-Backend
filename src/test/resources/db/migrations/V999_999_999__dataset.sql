...
$$
    ...
    BEGIN
        ...
        VALUES (global_admin_id, '08513d7b-cce1-4efe-bb27-8d936c4a12b4', 'USER', 'Jane', 'SMITH',
               ...
               (global_blocked_profile_id, 'f38ae886-757a-4329-a94f-9a92c0a9523b', 'USER', 'Emil', 'BRADFORD',
        ...
        VALUES (global_coordinator_id, global_coordinator_id, global_coordinator_id),
                    ...
                    LOOP
                        ...
                        FOR i IN 1..current_movement_participant_number
                            LOOP
                                ...
                                ORDER BY RANDOM()
                                LIMIT 1;
                                current_movement_vehicle_id = CASE
...
$$
    DECLARE
        ...
        current_project_end_time   TIME WITH TIME ZONE;
    BEGIN
        FOR current_movement_id IN SELECT id FROM tb_movement WHERE activity_id IS NOT NULL
            LOOP
