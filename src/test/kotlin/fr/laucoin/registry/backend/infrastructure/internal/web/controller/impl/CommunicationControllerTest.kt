...
class CommunicationControllerTest(@Autowired private val webClient: WebTestClient): TestContext() {
    @MockitoBean
    ...
    companion object {
        ...
        fun `Should findCommunications throw due to wrong params`(): Stream<Arguments> {
            return Stream.of(
                ...
                Arguments.of(projectId.toString(), null, null, null, null, "2024/11/14 18:34:33", null, PARAMETER_TYPE_MISMATCH),
