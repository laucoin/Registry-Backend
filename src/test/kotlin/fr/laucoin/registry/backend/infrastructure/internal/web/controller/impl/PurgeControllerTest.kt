...
class PurgeControllerTest(@Autowired private val webClient: WebTestClient): TestContext() {
    @MockitoBean
    ...
    fun `Should purgeProjectsContentsIfNecessary should return 200`() {
        ...
        whenever(communicationService.purgeOrphanCommunications(any(), any(), any())).thenReturn(Flux.just(UUID.randomUUID()))
