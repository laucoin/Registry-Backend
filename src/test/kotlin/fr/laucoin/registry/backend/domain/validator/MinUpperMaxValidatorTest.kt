...
class MinUpperMaxValidatorTest {
    ...
    fun `Should isValid validate Double values`(
        ...
        numberValidator.initialize(MinUpperMax(startField = "minDouble", endField = "maxDouble", message = "TEST_MESSAGE"))
    ...
    fun `Should isValid validate Float values`(
        ...
        numberValidator.initialize(MinUpperMax(startField = "minFloat", endField = "maxFloat", message = "TEST_MESSAGE"))
