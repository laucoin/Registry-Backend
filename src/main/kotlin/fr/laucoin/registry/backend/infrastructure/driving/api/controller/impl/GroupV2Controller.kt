...
import fr.laucoin.registry.backend.infrastructure.driving.api.controller.IGroupV2Controller
...
class GroupV2Controller(
	...
	override fun createGroup(
		...
		return service.createGroup(currentUser, groupModel).map(readerLightMapper::toDto).map {
			ResponseEntity.created(URI.create("$API_V2/projects/$projectId/groups/${it.id}")).body(it)
		}
	}
