...
object PreferenceFields {
    ...
    const val PREFERENCE_SELECTED_PROFILE_PROJECT_START_DATE = "${SELECTED_PROFILE_PREFIX}${PROJECT_PREFIX}$PROJECT_BEGIN_DATE"
    const val PREFERENCE_SELECTED_PROFILE_PROJECT_START_TIME = "${SELECTED_PROFILE_PREFIX}${PROJECT_PREFIX}$PROJECT_BEGIN_TIME"
    const val PREFERENCE_SELECTED_PROFILE_PROJECT_END_DATE = "${SELECTED_PROFILE_PREFIX}${PROJECT_PREFIX}$PROJECT_END_DATE"
    const val PREFERENCE_SELECTED_PROFILE_PROJECT_END_TIME = "${SELECTED_PROFILE_PREFIX}${PROJECT_PREFIX}$PROJECT_END_TIME"
    const val PREFERENCE_SELECTED_PROFILE_PROJECT_OPTIONS = "${SELECTED_PROFILE_PREFIX}${PROJECT_PREFIX}$PROJECT_OPTIONS"
    ...
    const val PREFERENCE_SELECTED_PROFILE_START_ACCESS_DATE = "${SELECTED_PROFILE_PREFIX}$PROJECT_PROFILE_START_ACCESS_DATE"
    const val PREFERENCE_SELECTED_PROFILE_START_ACCESS_TIME = "${SELECTED_PROFILE_PREFIX}$PROJECT_PROFILE_START_ACCESS_TIME"
