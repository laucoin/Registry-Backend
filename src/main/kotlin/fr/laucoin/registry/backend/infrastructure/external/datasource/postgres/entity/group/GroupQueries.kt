...
object GroupQueries {
    ...
    const val WITH_GROUP_INSIDE_MEMBERS = """
        inside_members AS (
            ...
            WHERE t.$VISIBLE IS TRUE AND t.$MOVEMENT_TYPE = 'IN' AND (
                (
                    (
    ...
    const val SELECT_MEMBERS_COUNTS = """
        ...
        inside_members.$GROUP_INSIDE_MEMBERS_COUNT,
        members.$GROUP_MEMBERS_COUNT - inside_members.$GROUP_INSIDE_MEMBERS_COUNT as $GROUP_OUTSIDE_MEMBERS_COUNT
    """

    const val GROUP_INSIDE_MEMBERS_JOIN = """
        INNER JOIN inside_members ON inside_members.$GROUP_CONTENT_GROUP_ID = t.$ID
    """
