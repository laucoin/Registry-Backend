...
import fr.laucoin.registry.backend.infrastructure.`in`.postgres.entity.role.RoleFields.PROJECT_ROLE_PERMISSION_TABLE
...
import fr.laucoin.registry.backend.infrastructure.`in`.postgres.entity.role.RoleFields.ROLE_NAME
import fr.laucoin.registry.backend.infrastructure.`in`.postgres.entity.role.RoleFields.ROLE_PERMISSION
import fr.laucoin.registry.backend.infrastructure.`in`.postgres.entity.role.RoleFields.ROLE_PERMISSIONS
import fr.laucoin.registry.backend.infrastructure.`in`.postgres.entity.role.RoleFields.USER_ROLE_PERMISSION_TABLE
import fr.laucoin.registry.backend.infrastructure.`in`.postgres.entity.role.RoleFields.USER_ROLE_TABLE
