...
object MovementQueries {
    ...
    const val CURRENT_MOVEMENT_CONTENT_JOIN =
        "INNER JOIN current_movement ON current_movement.$MOVEMENT_CONTENT_PARTICIPANT_ID = t.$MOVEMENT_CONTENT_PARTICIPANT_ID"
}
