...
data class CurrentUserEntity(
    ...
    var preferenceSelectedProfileStartAccess: ZonedDateTime? = null,
    @ReadOnlyProperty
    @Column(PREFERENCE_SELECTED_PROFILE_END_ACCESS)
    var preferenceSelectedProfileEndAccess: ZonedDateTime? = null,
    @ReadOnlyProperty
    ...
    var preferenceSelectedProfileEventStartTime: ZonedDateTime? = null,
    @ReadOnlyProperty
    @Column(PREFERENCE_SELECTED_PROFILE_EVENT_END_TIME)
    var preferenceSelectedProfileEventEndTime: ZonedDateTime? = null,
    @ReadOnlyProperty
