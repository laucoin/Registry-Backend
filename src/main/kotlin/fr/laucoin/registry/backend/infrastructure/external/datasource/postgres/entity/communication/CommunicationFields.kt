...
object CommunicationFields {
    ...
    const val COMMUNICATION_ACTIVITY_MIN_ALLOWED_PARTICIPANTS = "$COMMUNICATION_ACTIVITY_PREFIX$ACTIVITY_MIN_ALLOWED_PARTICIPANTS"
    const val COMMUNICATION_ACTIVITY_MAX_ALLOWED_PARTICIPANTS = "$COMMUNICATION_ACTIVITY_PREFIX$ACTIVITY_MAX_ALLOWED_PARTICIPANTS"
    const val COMMUNICATION_ACTIVITY_START_AVAILABILITY_DATE = "$COMMUNICATION_ACTIVITY_PREFIX$ACTIVITY_START_AVAILABILITY_DATE"
