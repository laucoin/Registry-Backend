...
CREATE INDEX tb_vehicle_index_project_id ON tb_vehicle (project_id);
...
ALTER TABLE tb_vehicle
    ADD CONSTRAINT tb_vehicle_project_fkey FOREIGN KEY (project_id) REFERENCES tb_project (id) ON DELETE CASCADE;
ALTER TABLE tb_vehicle
